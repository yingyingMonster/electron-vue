...
export const customerBillsHtml =  process.env.NODE_ENV === 'development' ? `http://localhost:${process.env.PORT}/static/bills/customer.html` : `file://${__static}/bills/customer.html`
export const handoverBillsHtml =  process.env.NODE_ENV === 'development' ? `http://localhost:${process.env.PORT}/static/bills/handover.html` : `file://${__static}/bills/handover.html`
